...
|:---|:---|:---|
|<img src=./img/facemosaic_hw_conf_v2l.png width=600>|<img src=./img/facemosaic_hw_conf_v2h.png width=600> |<img src=./img/facemosaic_hw_conf_v2n.png width=600> |
...
6. Build the application by following the commands below. 
    ...
    - For RZ/V2N,
      ```sh
      cmake -DCMAKE_TOOLCHAIN_FILE=./toolchain/runtime.cmake -DV2N=ON ..
      make -j$(nproc)
      ```
...
Replace each variable according to your board.  
    ...
    |RZ/V2N EVK|[exe_v2n](./exe_v2n)  |<span style="font-size: small">`https://github.com/renesas-rz/rzv_sample_apps/releases/download/v1.00/`</span>  |<span style="font-size: small">`S01_face_mosaic_deploy_tvm_v2h_v230.so`</span> |[Release v1.00](https://github.com/renesas-rz/rzv_sample_apps/releases/tag/v1.00/)  |
<!--    > Note: Since RZ/V2N is a brother chip of RZ/V2H, the same execution environment can be used.  -->
...
3. Rename the `S01_face_mosaic_deploy_*.so` to `deploy.so`.
    ...
    ```
4. Copy the following files to the following directories on the board’s rootfs (SD card):
   - For RZ/V2L
    ```
    /home/root/tvm
    ```
...
3. Following window shows up on HDMI screen.  
    ...
    |RZ/V2L EVK | RZ/V2H EVK | RZ/V2N EVK |
    |:---|:---|:---|
    |<img src=./img/facemosaic_v2l_normal.png width=350>| <img src=./img/facemosaic_v2h_normal.png width=350>  | <img src=./img/facemosaic_v2n_normal.png width=350>  |
...
4. Following window shows up on HDMI screen in Bounding Box mode by ececuting the command below.
    ...
    |RZ/V2L EVK |RZ/V2H EVK |RZ/V2N EVK |
    |:---|:---|:---|
    |<img src=./img/facemosaic_v2l_box.png width=350>  |<img src=./img/facemosaic_v2h_box.png width=350>  |<img src=./img/facemosaic_v2n_box.png width=350>  |
...
>**Note:** The verified continuous operation duration on the EVK board for each product is 48 hours.
...
The following limitation applies to this version:
- Continuous operation on the EVK board for each product is **verified only up to 48 hours**.  -->

## Appendix
The memory map of DRP-AI for the application of each product is shown below.
  |RZ/V2L DRP-AI mempry map |RZ/V2H DRP-AI mempry map |RZ/V2N DRP-AI mempry map |
  |:---|:---|:---|
  |<img src=./img/facemosaic_drpai_memorymap_v2l.png width=350>  |<img src=./img/facemosaic_drpai_memorymap_v2h.png width=350>  |<img src=./img/facemosaic_drpai_memorymap_v2n.png width=350>  |
...
- #### The memory area ①
  ...
  |RZ/V2N EVK|PreRuntime::Load( )|[PreRuntimeV2H.cpp](./src/PreRuntimeV2H.cpp) |
...
### V2H(V2N) has the following features:<br>
...
|RZ/V2N EVK|[addr_map.txt](./exe_v2n/face_mosaic_yolov3/preprocess/addr_map.txt)  |
> **Note1 :** The total size of memory area ① is the sum of the hexadecimal address and size on the last line.<br>
...
> **Note3 :** In V2H(V2N), the starting address of area ① is calculated by reading the starting address and size of DRP-AI in the device tree and subtracting the size of area ①.<br>
