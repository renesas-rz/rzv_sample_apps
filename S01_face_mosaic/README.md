...
3. Rename the `S01_face_mosaic_deploy_*.so` to `deploy.so`.
    ...
    ```
4. Copy the following files to the `/home/root/tvm` directory (RZ/V2L) or `/home/weston/tvm` directory (RZ/V2H, RZ/V2N) of the rootfs (SD Card) for the board.
    |File | Details |
    |:---|:---|
...
## Appendix
- The memory map of DRP-AI for the V2L and V2H(V2N) application is shown below.
    |RZ/V2L DRP-AI mempry map |RZ/V2H(V2N) DRP-AI mempry map |
    |:---|:---|
