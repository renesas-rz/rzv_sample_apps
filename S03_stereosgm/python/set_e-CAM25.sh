...
echo "e-CAM25" $cam_side $cam_width $cam_height
...
#v4l2-ctl -d /dev/video1 --set-ctrl vertical_flip=0
...
#media-ctl -d /dev/media0 -V "'ar0234 0-0042':0 [fmt:UYVY8_2X8/1280x720 field:none]"
media-ctl -d /dev/media0 -r
...
#media-ctl -d /dev/media1 -V "'ar0234 1-0042':0 [fmt:UYVY8_2X8/1280x720 field:none]"
media-ctl -d /dev/media1 -r
...
#media-ctl -d /dev/media0 -V "'ar0234 0-0042':0 [fmt:UYVY8_2X8/1920x1080 field:none]"
media-ctl -d /dev/media0 -r
media-ctl -d /dev/media0 -l "'csi-16000400.csi20':1 -> 'cru-ip-16000000.video0':0 [1]"
...
#media-ctl -d /dev/media1 -V "'ar0234 1-0042':0 [fmt:UYVY8_2X8/1920x1080 field:none]"
media-ctl -d /dev/media1 -r
media-ctl -d /dev/media1 -l "'csi-16010400.csi21':1 -> 'cru-ip-16010000.video1':0 [1]"
